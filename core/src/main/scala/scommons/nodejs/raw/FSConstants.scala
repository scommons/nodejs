...
/**
  * https://nodejs.org/docs/latest-v9.x/api/fs.html#fs_fs_constants_1
  */
@js.native
...
object FSConstants extends js.Object {
  ...
  val O_NOCTTY: Int = js.native //Flag indicating that if path identifies a terminal device,
  ...
  val O_DIRECTORY: Int = js.native //Flag indicating that the open should fail if the path is not a directory.
  
  val O_NOATIME: Int = js.native //Flag indicating reading accesses to the file system
                                 //  will no longer result in an update to the atime
                                 //  information associated with the file.
                                 //This flag is available on Linux operating systems only.
  
  val O_NOFOLLOW: Int = js.native //Flag indicating that the open should fail if the path is a symbolic link.
  
  val O_SYNC: Int = js.native //Flag indicating that the file is opened for synchronized I/O
                              //  with write operations waiting for file integrity.
  
  val O_DSYNC: Int = js.native //Flag indicating that the file is opened for synchronized I/O
                               //  with write operations waiting for data integrity.
  
  val O_SYMLINK: Int = js.native //Flag indicating to open the symbolic link itself
                                 //  rather than the resource it is pointing to.
  
  val O_DIRECT: Int = js.native //When set, an attempt will be made to minimize caching effects of file I/O.
  val O_NONBLOCK: Int = js.native //Flag indicating to open the file in nonblocking mode when possible.
  ...
  val S_IFBLK: Int = js.native //File type constant for a block-oriented device file.
  val S_IFIFO: Int = js.native //File type constant for a FIFO/pipe.
  val S_IFLNK: Int = js.native //File type constant for a symbolic link.
  val S_IFSOCK: Int = js.native //File type constant for a socket.
  ...
  //
  val S_IRWXU: Int = js.native //File mode indicating readable, writable, and executable by owner.
  val S_IRUSR: Int = js.native //File mode indicating readable by owner.
  val S_IWUSR: Int = js.native //File mode indicating writable by owner.
  val S_IXUSR: Int = js.native //File mode indicating executable by owner.
  val S_IRWXG: Int = js.native //File mode indicating readable, writable, and executable by group.
  val S_IRGRP: Int = js.native //File mode indicating readable by group.
  val S_IWGRP: Int = js.native //File mode indicating writable by group.
  val S_IXGRP: Int = js.native //File mode indicating executable by group.
  val S_IRWXO: Int = js.native //File mode indicating readable, writable, and executable by others.
  val S_IROTH: Int = js.native //File mode indicating readable by others.
  val S_IWOTH: Int = js.native //File mode indicating writable by others.
  val S_IXOTH: Int = js.native //File mode indicating executable by others.
}
